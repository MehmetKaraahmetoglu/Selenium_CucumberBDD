...
public class WebUniStepdefinitions {
    ...
    public void login_portal_a_kadar_asagi_iner() {
        //asagidaki kodlarda istedigimiz yere kadar indirir
        //login portala kadar indigimizde click problem oldugundan
        //contactUsButonuna kadar asagi indik
    ...
    public void diger_window_a_gecer() {
        //yeni acilan sayfayi acar, acilan sayfanin titleina ihtiyacimiz var bunu yapabilmek icin
    ...
    public void username_ve_password_kutularina_faker_ile_deger_yazdirir() {
        ...
        webUniPage.passwordKutusu.click();
    ...
    public void ok_diyerek_popup_i_kapatir() {
        ...
        Driver.getDriver().switchTo().alert().accept(); //popup u kabul ettik
    ...
    public void i_frame_den_cikis_yapar() {
        Driver.getDriver().switchTo().parentFrame();//bir ust iframee gecti
